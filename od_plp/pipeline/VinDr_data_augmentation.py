...
def augment_dataset():
    """
    Augment the VinDr-Mammo dataset
    """
    ...
    # Get all images
    image_paths = glob.glob(os.path.join(train_images_dir, '*.png'))
    ...
    for image_path in tqdm(image_paths, desc="Augmenting images"):
        ...
        for i in range(3):
            ...
            aug_image_path = os.path.join(train_images_dir, f"{aug_base_name}.png")
...
if __name__ == "__main__":
    print("Starting VinDr-Mammo dataset augmentation...")
    augment_dataset()
    print("VinDr-Mammo dataset augmentation completed!")
